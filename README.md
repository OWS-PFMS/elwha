...
**Phase 1–4 surface:** the `STANDARD`, `CENTERED`, **and** `RANGE` variants, horizontal orientation, the `XS`–`XL` size scale, the inset icon, continuous **and** stops, with an optional value indicator. The final V1 phase adds vertical orientation.
