...
/**
 * Starter smoke-test for {@link ElwhaChip}: a 4-by-5 variant × state matrix.
 *
 ...
 * LAF-tweak panel) lives in {@code ElwhaChipPlayground} (sub-story #241).
 *
 * <p>Run:
 *
 * <pre>
 *   mvn -q exec:java \
 *     -Dexec.mainClass=com.owspfm.elwha.chip.ElwhaChipDemo
 * </pre>
 *
 ...
 * @since v0.1.0
 */
public final class ElwhaChipDemo {

  private ElwhaChipDemo() {
  ...
  public static void main(final String[] args) {
    SwingUtilities.invokeLater(ElwhaChipDemo::launch);
  }

  private static void launch() {
    FlatLightLaf.setup();

    final JFrame frame = new JFrame("ElwhaChip demo");
  ...
  private static JPanel buildFooter() {
    ...
    final ElwhaChip interactive =
        new ElwhaChip("click me")
