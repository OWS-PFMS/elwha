...
/**
 * The 49 semantic color roles of the Elwha token vocabulary — the full standard Material 3 color
 * scheme.
 *
 ...
 * under the key {@code Elwha.color.<camelCaseKey>}, which {@link ElwhaTheme#install} writes.
 *
...
public enum ColorRole {
  ...
  private static final String KEY_PREFIX = "Elwha.color.";
   ...
   * "Elwha.color.onPrimaryContainer"}.
   *
