...
public enum TypeRole {
  ...
  /**
   * Title, large (22pt, regular) — the large {@code ElwhaCard} header.
   *
   * @version v0.1.0
   * @since v0.1.0
   */
  ...
  /**
   * Title, medium (16pt, medium) — the default {@code ElwhaCard} header.
   *
   * @version v0.1.0
   * @since v0.1.0
   */
  ...
  /**
   * Title, small (14pt, medium) — the {@code ElwhaCard} sub-header.
   *
   * @version v0.1.0
   * @since v0.1.0
   */
  ...
  /**
   * Body, large (16pt, regular) — {@code ElwhaCard} body text.
   *
   * @version v0.1.0
   * @since v0.1.0
   */
  ...
  /**
   * Body, medium (14pt, regular) — compact {@code ElwhaCard} body; the default text role.
   *
   * @version v0.1.0
   * @since v0.1.0
   */
  ...
  /**
   * Body, small (12pt, regular) — {@code ElwhaCard} summary and metadata text.
   *
   * @version v0.1.0
   * @since v0.1.0
   */
  ...
  /**
   * Label, large (14pt, medium) — the default {@code ElwhaChip} label.
   *
   * @version v0.1.0
   * @since v0.1.0
   */
  ...
  /**
   * Label, medium (12pt, medium) — the compact {@code ElwhaChip} label.
   *
   * @version v0.1.0
   * @since v0.1.0
   */
  ...
  private static final String KEY_PREFIX = "Elwha.type.";
