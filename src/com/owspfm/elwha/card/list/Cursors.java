...
/**
 * Lazily-built custom cursors for {@link ElwhaCardList}'s drag interaction.
 *
...
public final class Cursors {
  ...
  public static Cursor grab() {
    ...
    if (grabCached == null) {
      grabCached = loadCursor("grab", isDarkTheme(), new Point(15, 8), "ElwhaCardList.grab", true);
    }
    return grabCached;
  }
  ...
  public static Cursor grabbing() {
    ...
    if (grabbingCached == null) {
      grabbingCached =
          loadCursor("grabbing", isDarkTheme(), new Point(13, 13), "ElwhaCardList.grabbing", false);
    }
