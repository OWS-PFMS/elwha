...
/**
 * Minimal smoke-test demo for {@link FlatCard}: one card per variant, one per interaction mode,
...
public final class FlatCardDemo {
  ...
  public static void main(final String[] args) {
    SwingUtilities.invokeLater(
        () -> {
          FlatLightLaf.setup();
          JFrame frame = new JFrame("FlatCard demo");
  ...
  private static FlatCard simpleCard(final CardVariant v, final String label) {
    return new FlatCard()
        .setVariant(v)
  ...
  private static FlatCard modeCard(final CardInteractionMode m, final String label) {
    return new FlatCard()
