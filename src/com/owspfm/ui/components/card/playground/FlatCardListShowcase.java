...
public final class FlatCardListShowcase extends JPanel {
  ...
  private final FlatCardList<DemoItem> list;
  private final JTextArea status;
  private final JTextArea snippet;
  private final Random random = new Random(42);

  private JComboBox<FlatListOrientation> orientationBox;
  ...
  public FlatCardListShowcase() {
    ...
    list = new FlatCardList<>(model, adapter);
  ...
  private JComboBox<FlatListOrientation> buildOrientationBox() {
    orientationBox = new JComboBox<>(FlatListOrientation.values());
  ...
  private void syncFromControls() {
    final FlatListOrientation orientation = (FlatListOrientation) orientationBox.getSelectedItem();
  ...
  private void onSelectionChanged(
      final com.owspfm.ui.components.card.list.CardSelectionEvent<DemoItem> event) {
  ...
  private void updateSnippet() {
    ...
    sb.append("    .setOrientation(Orientation.")
        .append(((FlatListOrientation) orientationBox.getSelectedItem()).name())
        .append(")\n");
    if (orientationBox.getSelectedItem() == FlatListOrientation.GRID) {
