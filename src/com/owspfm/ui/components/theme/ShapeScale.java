...
/**
 * The 7-step corner-radius scale of the FlatComp token vocabulary, lifted from Material 3.
 *
 * <p>Each step resolves at paint time from {@link UIManager} under the key {@code
 * FlatComp.shape.<key>}, which {@link FlatCompTheme#install} writes. The values are fixed in v1 —
...
public enum ShapeScale {
  ...
  SM("sm", 8),
  /**
   * Medium rounding (12px) — the {@code FlatCard} default.
   *
   * @version v0.1.0
   * @since v0.1.0
   */
  ...
  private static final String KEY_PREFIX = "FlatComp.shape.";
  ...
  /**
   * Returns the compiled-in v1 default radius for this step — the value {@link FlatCompTheme}
