...
/**
 * Loads a {@link Theme} from a FlatComp-normalized palette JSON resource.
 *
 ...
 * role's {@code camelCase} key mapped to a {@code "#rrggbb"} string. FlatComp owns this contract; a
 * documented, automatable conversion from the M3 theme builder's native export produces it. See
 * Appendix B of {@code flatcomp-theme-install-api.md}.
 *
