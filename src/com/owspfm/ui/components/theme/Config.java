...
/**
 * The complete, immutable input to {@link FlatCompTheme#install} — a {@link Theme}, a {@link Mode},
 * and a {@link Typography}.
 *
 * <p>Built through {@link #builder()} (or, equivalently, {@link FlatCompTheme#config()}). {@code
