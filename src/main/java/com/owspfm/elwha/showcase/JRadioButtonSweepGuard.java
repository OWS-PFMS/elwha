...
/**
 * Headless regression guard for #424: the storefront must not reintroduce a raw {@code
 * JRadioButton} where a one-of-many choice belongs. Fails on any non-allowlisted {@code new
 * JRadioButton} in the guarded packages.
 *
...
public final class JRadioButtonSweepGuard {
  ...
  public static void main(final String[] args) throws IOException {
    RawSwingSweep.report("JRadioButton", "ElwhaRadioButton in an ElwhaRadioGroup", ALLOWLIST);
  }
}
