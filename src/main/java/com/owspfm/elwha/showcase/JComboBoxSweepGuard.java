...
/**
 * Headless regression guard for #424: the storefront must not reintroduce a raw {@code JComboBox}
 * where a typed exposed dropdown belongs. Fails on any non-allowlisted {@code new JComboBox} in the
 * guarded packages.
 *
...
public final class JComboBoxSweepGuard {
  ...
  public static void main(final String[] args) throws IOException {
    RawSwingSweep.report("JComboBox", "ElwhaSelectField<T>", ALLOWLIST);
  }
}
