...
/**
 * Headless regression guard for #424: the storefront must not reintroduce a raw {@code JCheckBox}
 * where a checkable option belongs. Fails on any non-allowlisted {@code new JCheckBox} in the
 * guarded packages.
 *
 ...
 * @since v0.5.0
 */
public final class JCheckBoxSweepGuard {
  ...
  public static void main(final String[] args) throws IOException {
    RawSwingSweep.report(
        "JCheckBox", "ElwhaCheckbox (or ElwhaSwitch where the site is settings-shaped)", ALLOWLIST);
  }
}
