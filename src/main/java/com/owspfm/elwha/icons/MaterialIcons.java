...
public final class MaterialIcons {
   ...
   * design-intended visual weight. Chip-context callers (the chip list and playground surfaces) pin
   * to a smaller explicit size today; the ElwhaCard V2 / ElwhaChip V2 refresh will revisit chip
   * icon sizing on its own terms.
   */
