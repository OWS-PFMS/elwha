...
/**
 * Observable, ordered collection of items rendered by a {@link ElwhaChipList}.
 *
 * <p>Modeled on {@link javax.swing.ListModel} and on the sibling {@link
 * com.owspfm.elwha.card.v1.list.CardListModel}, with the same MOVED-event extension.
 *
