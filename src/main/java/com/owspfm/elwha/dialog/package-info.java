 ...
 * About-dialog chrome; exists because {@code ElwhaButton extends JComponent} closes {@code
 * JOptionPane} to Elwha actions.
 *
 * <p>Design: {@code docs/research/elwha-dialog-design.md}.
 *
